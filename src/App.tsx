...
import CompleteCard from "./pages/complete-card";
import EditCard from "./pages/edit-card";
import { Route } from "./providers/route-provider/route";
...
function App() {
  return (
    <Router>
      ...
      <Route path="/edit-card/:cardId" component={<EditCard />} />
      <Route
        path="/edit-card/:cardId/complete-card"
